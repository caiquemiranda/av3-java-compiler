...
public class Av3Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "DO", "FOR", "PRINTF", "SCANF", "INT_T", "DOUBLE_T", 
			"BOOL_T", "TRUE", "FALSE", "PLUS", "MINUS", "MUL", "DIV", "MOD", "EQ", 
			"NEQ", "LT", "LTE", "GT", "GTE", "AND", "OR", "NOT", "ASSIGN", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "COMMA", "SEMI", "ID", "DOUBLE_LIT", "INT_LIT", 
			"DIGITS", "EXP_PART", "BOOL_LIT", "STRING_LIT", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT"
		};
	}
